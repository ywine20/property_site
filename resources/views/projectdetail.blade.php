...
@section('css')
    ...
    <main class="main">
                ...
                <div class="priceImage">
                    <div class="row py-3 ">
                        ...
                        <div class="col-12 pt-2 pt-md-3 pt-lg-5 mx-auto d-flex justify-content-center align-items-center ">
                            <div class="d-flex justify-content-center align-items-center overflow-hidden price-img-div"
                                style="">
                                <img src="{{ asset('storage/images/priceImg/' . $project->priceImg) }}" alt=""
        ...
        <div class="container-fluid  bg-secondary position-relative">
                            ...
                            <div class="mx-auto mt-4 my-md-5 px-2 px-md-0 siteProgressAlert">
                                @if ($siteProgress)
                                    <div class="row progressCard bg-secondary d-flex rounded rounded-3 overflow-hidden "
                                        style="box-shadow:1px 1px 6px #eac376;">
                                        ...
                                        <div
                                            class="col-8 col-md-9 col-xxl-10  d-flex align-items-baseline justify-content-start py-2">
            ...
            @if ($assets == null || $assets->site_progress != '1')
                <div id="progressLock"
                    class="lockSection px-0 w-100 h-100 position-absolute bg-black bg-opacity-50 start-0 top-0 text-center d-flex align-items-center justify-content-center"
                    style="backdrop-filter:blur(10px)">
                    <div class="d-flex flex-column align-items-center justify-content-center">
                        <img src="{{ asset('images/lock.png') }}" alt="">
                        <div class="text-primary my-3">
                            Upgrade your account for <a href="{{ route('contact-form') }}" target="_blank"
                                class="fw-bold text-decoration-none">Progress</a> section
                        </div>
                ...
                <div class="gallery py-3 py-md-5">
                    ...
                    <div class="row row-cols-2 row-cols-md-5 row-cols-xl-5 g-lg-3 g-md-2 g-1">
                        ...
                        @if ($project->previewimages->small_img1)
                            <div class="col" style="aspect-ratio: 1;">
                                <a href="/storage/images/gallery/{{ $project->previewimages->small_img1 }}"
                                    class="myGallery" data-gall="myGallery" data-maxwidth="600px"
                                    data-overlay="#423e3ddf">
                        ...
                        @if ($project->previewimages->small_img2)
                            <div class="col" style="aspect-ratio: 1;">
                                <a href="/storage/images/gallery/{{ $project->previewimages->small_img2 }}"
                                    class="myGallery" data-gall="myGallery" data-maxwidth="600px"
                                    data-overlay="#423e3ddf">
                        ...
                        @if ($project->previewimages->small_img3)
                            <div class="col" style="aspect-ratio: 1;">
                                <a href="/storage/images/gallery/{{ $project->previewimages->small_img3 }}"
                                    class="myGallery" data-gall="myGallery" data-maxwidth="600px"
                                    data-overlay="#423e3ddf">
                        ...
                        @if ($project->previewimages->small_img4)
                            <div class="col" style="aspect-ratio: 1;">
                                <a href="/storage/images/gallery/{{ $project->previewimages->small_img4 }}"
                                    class="myGallery" data-gall="myGallery" data-maxwidth="600px"
                                    data-overlay="#423e3ddf">
                        ...
                        @if ($project->previewimages->small_img5)
                            <div class="col" style="aspect-ratio: 1;">
                                <a href="/storage/images/gallery/{{ $project->previewimages->small_img5 }}"
                                    class="myGallery" data-gall="myGallery" data-maxwidth="600px"
                                    data-overlay="#423e3ddf">
                        ...
                        @if ($project->previewimages->small_img6)
                            <div class="col" style="aspect-ratio: 1;">
                                <a href="/storage/images/gallery/{{ $project->previewimages->small_img6 }}"
                                    class="myGallery" data-gall="myGallery" data-maxwidth="600px"
                                    data-overlay="#423e3ddf">
                        ...
                        @if ($project->previewimages->small_img7)
                            <div class="col" style="aspect-ratio: 1;">
                                <a href="/storage/images/gallery/{{ $project->previewimages->small_img7 }}"
                                    class="myGallery" data-gall="myGallery" data-maxwidth="600px"
                                    data-overlay="#423e3ddf">
                        ...
                        @if ($project->previewimages->small_img8)
                            <div class="col" style="aspect-ratio: 1;">
                                ...
                                <a href="/storage/images/gallery/{{ $project->previewimages->small_img8 }}"
                                    class="myGallery" data-gall="myGallery" data-maxwidth="600px"
                                    data-overlay="#423e3ddf">
                        ...
                        @if ($project->previewimages->small_img9)
                            <div class="col" style="aspect-ratio: 1;">
                                <a href="/storage/images/gallery/{{ $project->previewimages->small_img9 }}"
                                    class="myGallery" data-gall="myGallery" data-maxwidth="600px"
                                    data-overlay="#423e3ddf">
                                        ...
                                        @foreach ($albums as $album)
                                            <div class="col text-center">
                                                @if ($assets != null && $assets->legal_document == '1')
                                                    <a href="{{ route('client-album.show', ['projectId' => $siteProgress->project_id, 'id' => $album->id]) }}"
                                                        title="Detail" class="text-decoration-none">
                                                    @else
            ...
            @if ($assets == null || $assets->legal_document != '1')
                <div id="albumLock"
                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="text-primary my-3   ">
                            Upgrade your account for <a href="{{ route('contact-form') }}" target="_blank"
                                class="fw-bold text-decoration-none">Legal Documents</a> section
                        </div>
                        <a href="{{ route('contact-form') }}" target="_blank">
                            <button class="btn btn-outline-primary">Contact Us</button>
                        </a>
