                                ...
                                <div class="col-8 col-md-9 col-xxl-10  d-flex align-items-baseline justify-content-start py-2">
                                    ...
                                    <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                        <div class="w-100 align-self-baseline align-self-md-end ">
                                            <div class="time mb-1 text-end ">
                                                <small class="text-white-50">
                                                    @if($siteProgress->created_at->diffInWeeks(now()) < 4) <i class="bi bi-clock text-white-50"></i>
                                        ...
                                        <div class="d-flex justify-content-start align-items-center">
                                            ...
                                            @else
                                            <a href="{{ route('client-siteProgress.show', ['projectId' => $siteProgress->project_id, 'id' => $siteProgress->id]) }}" class="btn btn-sm btn-outline-primary me-2">
                                                <i class="bi bi-eye text-primary"></i>
                                                Show Detail
                                            </a>
                                            @endif
                        ...
                        <div class="mx-auto py-3">
                            <div class="row row-cols-3 row-cols-md-4 row-cols-lg-5 row-cols-xl-5 g-2 gy-3 g-md-3 g-lg-5">
                                ...
                                <div class="col text-center">
                                    ...
                                    <a href="{{ route('client-album.show', ['projectId' => $siteProgress->project_id, 'id' => $album->id]) }}" title="Detail" class="text-decoration-none">
                                        @else
