            ...
            <div class="col-12">
                ...
                <div class="row row-cols-auto g-1 g-md-3  mb-3 siteProgressAlert">
                    <div class="col-12 px-2 px-md-3 px-lg-5">
                        <div class="row bg-white progressCard d-flex flex-row rounded rounded-3 overflow-hidden shadow-sm border" style="">
                            <div class="col-4 col-md-3 col-lg-2 p-1 p-md-2 overflow-hidden img-col">
                                <div id="siteprogressId{{ $siteProgress->id }}" class="siteprogressImage bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center overflow-hidden position-relative w-100 h-100 rounded rounded-2 " style="cursor:pointer">
                            ...
                            <div class="col-8 col-md-9 col-lg-10 d-flex align-items-baseline justify-content-start py-2 px-1 px-md-2">
                                ...
                                <div class="d-flex flex-column justify-content-center align-items-start w-100">
                                    <div class="w-100 text-md-end ">
                                        <div class="time text-muted mb-1 ">
                                            <small class="">
                                                @if($siteProgress->created_at->diffInWeeks(now()) < 4) 
                                    ...
                                    <div class="d-flex justify-content-start align-items-center">
                                        <a href="{{ route('client-siteProgress.show', ['projectId' => $siteProgress->project_id, 'id' => $siteProgress->id]) }}" class="btn btn-sm btn-outline-secondary me-2">
