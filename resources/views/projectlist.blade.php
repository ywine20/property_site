        ...
        <form action="{{ route('advance') }}" method="GET">
            <div id="search" class="pt-5">
                ...
                <div class="input-group mb-4">
                    ...
                    @else
                    <input type="text" name="search" maxlength="50" class="form-control" placeholder="@lang('public.search')" />
                    @endif
                                ...
                                <div class="row g-4 g-lg-2 mx-auto">
                                    <div class="col-12 col-lg-5 align-items-center d-flex flex-column flex-md-row justify-content-center">
                                        <select id="chooseCategory" class="form-select mb-3 mb-md-0 me-0 me-lg-3 me-md-1 w-100" onchange="getValue('chooseCategory','result-category')" aria-label=".form-select-sm example" name="category">
                                            <option value="">@lang('public.category')</option>
                                            @if (!empty($categories))
                                            @foreach ($categories as $c)
                                            <option value="{{ $c->id }}" {{ $c->category_name == $findCat ? 'selected' : '' }}>
                                                {{ $c->category_name }}
                                            </option>
                                            @endforeach
                                            @endif
                                        ...
                                        <select id="chooseTownShip" class="form-select me-lg-3 ms-0 ms-md-1" onchange="getValue('chooseTownShip','result-township')" aria-label=".form-select-sm example" name="township">
                                            <option value="">@lang('public.township')</option>
                                            @if (!empty($towns))
                                            @foreach ($towns as $t)
                                            <option value="{{ $t->id }}" {{ $t->name == $findTon ? 'selected' : '' }}>{{ $t->name }}
                                            </option>
                                            @endforeach
                                            @endif
                                        </select>
                                    ...
                                    <div class="col-12 col-lg-5">
                                        ...
                                        <div class="">
                                            <div class="row row-cols-2 mb-0 gx-2 price-input ">
                                                <div class="col">
                                                    <div class="row g-0">
                                                        <label for="inputMin" class="col-sm-2 col-form-label text-center pt-0 pt-md-2">@lang('public.min')</label>
                                                        <div class="col-sm-10">
                                                            @isset($finPro)
                                                ...
                                                <div class="col">
                                                    <div class="row g-0">
                                                        <label for="inputMax" class="col-sm-2 col-form-label text-center pt-0 pt-md-2">@lang('public.max')</label>
                                                        <div class="col-sm-10">
                                                            @isset($findPro)
                                ...
                                <div class="row row-cols-1 h-100 w-100 g-0">
                                    ...
                                    <div class="col-7 bg-secondary">
                                        <div class="card-body  text-primary px-2 px-md-2 px-lg-2 my-0 my-lg-0">
                                            ...
                                            <span class="fw-bold my-1 my-md-2 my-lg-2 range d-block text-primary text-truncate">{{ $p->lower_price }}
