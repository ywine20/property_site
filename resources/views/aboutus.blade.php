                  ...
                  <div class="row py-4 py-md-5 py-lg-5 gx-1 justify-content-center align-items-center">
                      ...
                      <div class="col-md-11 col-lg-7 col-xl-7 py-3 pt-md-4 pb-md-0 py-lg-0">
                          ...
                          <div class="text mt-1 mt-md-3 px-0 px-md-2 px-lg-5">
                              <p>
                                  Sun Myat Tun, popularly known as SMT, was establish in 2009. SMT mainly focus on started building
                                  infrastructure projects for roads, bridges and power lines.
                              </p>
                              <p>                                
                                  In 2011, SMT entered the building of accommodation housing
                                  for government institutions. In 2013, SMT initiated the development
                                  of Low-Cost Housing by joint development with landowners. 
                              </p>
                              <p>
                                  In 2020, Estate Owl has 155 joint development projects and
                                  providing thousands of homes to local people within ten years
                                  from 2013 up to 2023. SMT successfully handled many Turnkey
                                  Projects by government in 2018 and 2019.
                              </p>
                          </div>
                          </div>
                      </div>
                          ...
                          <div class="row py-5 gx-0 gx-md-5  gx-lg-1 gx-xl-5">
                              <div class="col-12 col-md-12 col-lg-6">
                                <div class="our-vision">
                                  <div class="card">
                                      <h4 class="mb-2 mb-md-3 fw-bold">OUR VISION</h4>
                                      <p>
                                          SMT is currently developing 155 projects and providing more than 1,000 units of both Low-Cost Housing and Affordable Housing.
                                      </p>
                                      <p class="mb-0">
                                          Our Vision is to develop 50,000 homes within next 5 years and To be sustainable developer and to be the key trend developer in this business sector of Low-Cost and Affordable housing development 
                                      </p>
                                  </div>
                                </div>
                              </div>
                              <div class="col-12 col-md-12 col-lg-6">
                                <div class="our-mission">
                                  <div class="card">
                                      <h4 class="mb-2 mb-md-3 fw-bold">OUR MISSION</h4>
                                      <p>
                                          SMT created a market of affordable modernize housing with monthly instalment payment scheme by supporting of the big private Banks of Myanmar since Low-income group people are struggling to own their new houses.
      
                                      </p>
                                      <p class="mb-0">
                                          Our mission is to create a comfortable and modernized living development for Our Customers and Our People with the best in quality and affordability   
                                      </p>
                                  </div>
                                </div>
                              </div>
              ...
              <div class="container px-0">
                  <section id="company-timeLine" class="">
                      <div class="row pt-3 pt-md-5 pb-3 gx-0">
                          <div class="col-12">
                            <h3 class="text-center fw-bold mb-2 mb-md-4 mb-xl-2 title">COMPANY TIMELINE</h3>
                          </div>
                          <div class="col-12">
              ...
              <div class="container px-0 overflow-hidden">
                <section class="achievement-awards ">
                    <div class="row py-3 px-2 px-md-5 pb-md-5 ">
                        <div class="col-12">
                          <h3 class="text-center fw-bold mt-3 mb-3 mb-md-5 title">ACHIEVEMENT & AWARDS</h3>
                        </div>
                  ...
                  <section id="uNayLinTun">
                    <div class="row pt-3 pt-md-3 pb-3 gx-0 d-flex justify-content-center align-items-center">
                      ...
                      <div class="col-12 col-md-6 col-lg-4 col-xl-4 ps-0 ps-md-3 text-center text-md-start text">
                        ...
                        <span class="d-block mb-3 fs-5">Yangon University of Medicine (1) <br> (M.B.B.S Holder) in 2006</span>
                        <div class="mb-3 fs-6">
                          <span class="d-block">
              ...
              <div class="container px-0">
                <section id="organization-chart" class="">
                    <div class="row py-3 py-md-5 gx-0">
                        <div class="col-12">
                          <h3 class="text-center fw-bold mb-3 mb-md-5 title">ORGANIZATION CHART</h3>
                        </div>
                        <div class="col-12">
                          <div class="w-100 px-2">
                ...
                <div class="container px-0 overflow-hidden">
                  <section id="event-activities">
                      <div class="row py-3 px-2 px-md-0 py-md-5 ">
                          <div class="col-12">
                            <h3 class="text-center fw-bold mb-3 mb-md-5 title">EVENT & ACTIVITIES</h3>
                          </div>
            ...
            <!-- brand partnership -->
              <div class="container px-0 overflow-hidden">
                <section id="brand-partnership">
                    <div class="row py-3 px-2 px-md-0  py-md-5  ">
                        <div class="col-12">
                          <h3 class="text-center fw-bold mb-2 mb-md-4 title">BRAND PARTNERSHIP</h3>
                        </div>
                        <div class="col-12 second-col">
