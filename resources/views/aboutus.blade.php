                ...
                <section id="core-value" class="">
                    <div class="row py-3 py-lg-4 py-xl-5 gx-0">
                        <div
                            ...
                            <div class="w-75  px-2">
                                <img src="./image/aboutus/coreValue/coreValue.png" alt="" class="w-100"
                                    style="filter: drop-shadow(-5px 5px 6px rgba(0, 0, 0, 0.129));
                              ;">
                            </div>
                        </div>
                        <div
                            class="col-12 col-md-6 d-flex justify-content-center justify-content-md-start align-items-center ps-0 ps-md-5">
                            ...
                            <div class="row row-cols-2 row-cols-md-3 g-2 gx-md-3 gy-3 awards-row">
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden">
                                        <img src="./image/aboutus/smtAward/Best Commercial Developer.png" class="w-100"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden">
                                        <img src="./image/aboutus/smtAward/MM Best Mix Used Developer .png" class="w-100"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden">
                                        <img src="./image/aboutus/smtAward/MM Best Retail Development.png" class="w-100"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden">
                                        <img src="./image/aboutus/smtAward/SMT Best Marketing Campaign.png" class="w-100"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden">
                                        <img src="./image/aboutus/smtAward/SMT Best Mixed Use Developer.png" class="w-100"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden">
                                        <img src="./image/aboutus/smtAward/Special Recognition for Building Communitues.png"
                                            class="w-100" alt="">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row pt-3 pt-md-3 pb-3 gx-0 d-flex justify-content-center align-items-center">
                        <div class="col-9 col-md-5 col-lg-4 col-xl-3 d-flex justify-content-center align-items-center">
                            <div class="w-75 overflow-hidden mb-4 mb-md-0">
                                <img src="./image/aboutus/unaylintun/unaylintunwithshadow.png" alt=""
                                    class="w-100 h-100">
                            </div>
                        </div>
                        <div class="col-12 col-md-6 col-lg-4 col-xl-4 ps-0 ps-md-3 text-center text-md-start text">
                            ...
                            <a href="{{ url('dprofile') }}" class="btn btn-secondary text-primary fw-bold"
                                role="button">
                                Read More
                            </a>
                        </div>
                            ...
                            <div class="row row-cols-3 row-cols-md-4 row-cols-lg-5 g-2 mb-3">
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden rounded ">
                                        <a href="./image/aboutus/eventActivities/Picture1.jpg" class="event"
                                            data-gall="myevent" data-maxwidth="800px" data-overlay="#423e3ddf">
                                            <!-- <img src="./image/gallery/g10.jpg" style="width: 100%;height:100%;object-fit:cover;" alt=""> -->
                                            <img src="./image/aboutus/eventActivities/Picture1.jpg" alt=""
                                                class="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden rounded">
                                        <a href="./image/aboutus/eventActivities/Picture2.jpg" class="event"
                                            data-gall="myevent" data-maxwidth="800px" data-overlay="#423e3ddf">
                                            <img src="./image/aboutus/eventActivities/Picture2.jpg" alt=""
                                                class="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden rounded">
                                        <a href="./image/aboutus/eventActivities/Picture3.jpg" class="event"
                                            data-gall="myevent" data-maxwidth="800px" data-overlay="#423e3ddf">
                                            <img src="./image/aboutus/eventActivities/Picture3.jpg" alt=""
                                                class="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden rounded">
                                        <a href="./image/aboutus/eventActivities/Picture4.jpg" class="event"
                                            data-gall="myevent" data-maxwidth="800px" data-overlay="#423e3ddf">
                                            <img src="./image/aboutus/eventActivities/Picture4.jpg" alt=""
                                                class="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden rounded">
                                        <a href="./image/aboutus/eventActivities/Picture5.jpg" class="event"
                                            data-gall="myevent" data-maxwidth="800px" data-overlay="#423e3ddf">
                                            <img src="./image/aboutus/eventActivities/Picture5.jpg" alt=""
                                                class="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden rounded">
                                        <a href="./image/aboutus/eventActivities/Picture6.jpg" class="event"
                                            data-gall="myevent" data-maxwidth="800px" data-overlay="#423e3ddf">
                                            <img src="./image/aboutus/eventActivities/Picture6.jpg" alt=""
                                                class="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden rounded">
                                        <a href="./image/aboutus/eventActivities/Picture7.jpg" class="event"
                                            data-gall="myevent" data-maxwidth="800px" data-overlay="#423e3ddf">
                                            <img src="./image/aboutus/eventActivities/Picture7.jpg" alt=""
                                                class="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden rounded">
                                        <a href="./image/aboutus/eventActivities/Picture8.jpg" class="event"
                                            data-gall="myevent" data-maxwidth="800px" data-overlay="#423e3ddf">
                                            <img src="./image/aboutus/eventActivities/Picture8.jpg" alt=""
                                                class="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden rounded">
                                        <a href="./image/aboutus/eventActivities/Picture9.jpg" class="event"
                                            data-gall="myevent" data-maxwidth="800px" data-overlay="#423e3ddf">
                                            <img src="./image/aboutus/eventActivities/Picture9.jpg" alt=""
                                                class="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden rounded">
                                        <a href="./image/aboutus/eventActivities/Picture10.jpg" class="event"
                                            data-gall="myevent" data-maxwidth="800px" data-overlay="#423e3ddf">
                                            <img src="./image/aboutus/eventActivities/Picture10.jpg" alt=""
                                                class="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden rounded">
                                        <a href="./image/aboutus/eventActivities/Picture11.jpg" class="event"
                                            data-gall="myevent" data-maxwidth="800px" data-overlay="#423e3ddf">
                                            <img src="./image/aboutus/eventActivities/Picture11.jpg" alt=""
                                                class="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden rounded">
                                        <a href="./image/aboutus/eventActivities/Picture12.jpg" class="event"
                                            data-gall="myevent" data-maxwidth="800px" data-overlay="#423e3ddf">
                                            <img src="./image/aboutus/eventActivities/Picture12.jpg" alt=""
                                                class="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden rounded">
                                        <a href="./image/aboutus/eventActivities/Picture13.jpg" class="event"
                                            data-gall="myevent" data-maxwidth="800px" data-overlay="#423e3ddf">
                                            <img src="./image/aboutus/eventActivities/Picture13.jpg" alt=""
                                                class="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="w-100 h-100 overflow-hidden rounded">
                                        <a href="./image/aboutus/eventActivities/Picture14.jpg" class="event"
                                            data-gall="myevent" data-maxwidth="800px" data-overlay="#423e3ddf">
                                            <img src="./image/aboutus/eventActivities/Picture14.jpg" alt=""
                                                class="">
                                        </a>
                                    </div>
                                </div>
        ...
        <div class="container px-0 overflow-hidden">
            <section id="brand-partnership">
                <div class="row py-3 px-2 px-md-0  py-md-5  ">
                    ...
                    <div class="col-12 second-col">
                        <div
                            class="row row-cols-3 row-cols-md-4 row-cols-xl-6 g-3 d-flex justify-content-center align-items-center ">
                            <div class="col">
                                <div class="overflow-hidden">
                                    <img src="./image/aboutus/brandPartnership/kbzbank.png" alt=""
                                        class="">
                                </div>
                            </div>
                            <div class="col">
                                <div class="overflow-hidden">
                                    <img src="./image/aboutus/brandPartnership/ayabank.png" alt=""
                                        class="">
                                </div>
                            </div>
                            <div class="col">
                            ...
                            <div class="col d-none">
                                <div class="overflow-hidden">
                                    <img src="./image/aboutus/brandPartnership/Hyundai_logo_2-700x102.png" alt=""
                                        class="">
                                </div>
                            </div>
                            <div class="col d-none">
                                <div class="overflow-hidden">
                                    <img src="./image/aboutus/brandPartnership/zwareGroup.png" alt=""
                                        class="">
                                </div>
                            </div>
                            <div class="col d-none">
                                <div class="overflow-hidden">
                                    <img src="./image/aboutus/brandPartnership/liveLife.png" alt=""
                                        class="">
                                </div>
                            </div>
                            <div class="col d-none">
                            ...
                            <div class="col d-none">
                                <div class="overflow-hidden">
                                    <img src="./image/aboutus/brandPartnership/schindler.png" alt=""
                                        class="">
                                </div>
                            </div>
                        </div>
