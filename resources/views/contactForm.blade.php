            ...
            <div class="container-fluid px-0 bg-secondary reach-out-container">
              <div id="reach" class="w-100 reach-out overflow-hidden d-flex justify-content-center align-items-center position-relative">
                <div class="text-center text-primary reach-out-text position-absolute">
                  <span class="h4 text-primary">REACH OUT TO US</span>
                  <p class="fw-light mt-3 text-primary">Get a question abut SMT construction? Have some suggestions or just want to say hi? Contact Us : </p>
                </div>
              </div>
            </div>
        <!-- end reach out to us -->
                    ...
                    <div class=" d-flex flex-column flex-md-row flex-lg-column justify-content-center align-items-center contact-static">
                      ...
                      <div class="contact-static-card">
                          <div class="card mb-3">
                            ...
                            No (19/21), 45th Street Lower Block, Botahtaung Township, Yangon, Myanmar.
                          </div>
                          <div class="card mb-3">
...
{{--                          </div>--}}
{{--                          @endif--}}
                          <input type="email"  value="{{old('email')}}" class="form-control @error('email') is-invalid @enderror " name="email" id="email" placeholder="Enter your email">
                        </div>
...
{{--                          </div>--}}
{{--                          @endif--}}
                          <input type="text"  value="{{old('phone')}}" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" placeholder="Enter your phone">
                        </div>
                        <div class="col-12 mb-2">
...
{{--                          </div>--}}
{{--                          @endif--}}
                          <input type="text"  value="{{old('subject')}}" class="form-control @error('subject') is-invalid @enderror" name="subject" id="subject" placeholder="Enter subject">
                        </div>
                        <div class="col-12 mb-2">
...
{{--                          </div>--}}
{{--                          @endif--}}
                          <textarea name="message"   id="" cols="30" rows="5" class="form-control @error('message') is-invalid @enderror " placeholder="Please Fill Your Message">{{old('message')}}</textarea>
                        </div>
                        <div class="col-12 mb-2">
              ...
              <div id="map">
                <div class="row">
                  <div class="col-12 map-div p-0">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7640.165413485923!2d96.16759259999999!3d16.772560300000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30c1ec8944b0cec7%3A0xb9ac46d1e81aa262!2s45th%20St%2C%20Yangon!5e0!3m2!1sen!2smm!4v1676004639196!5m2!1sen!2smm" class="w-100 iframe-map" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                  </div>
                </div>
              </div>
            </div>
