                    ...
                    <div class="col-12">
                        <div
                            ...
                            <form method="post" id="multiForm">
                                @csrf
                                <button type="button" class="btn mx-1 trash-icon px-2 py-1 position-relative "
                                    id="multiDeleteBtn">
                                    <i class="bi bi-trash text-danger fa-fw fs-4"></i>
                                    <span id="checkedCount"
                                        class="position-absolute rounded-circle bg-danger border border-secondary text-white d-flex justify-content-center align-items-center p-1"
                                        style="width: 15px;height: 15px;font-size: 12px;top: 50%;">0</span>
                                </button>
                            </form>
                                                    ...
                                                    <tr id="row{{ $p->id }}">
                                                        <td class="text-center">
                                                            <input type="checkbox" name="chk[]"
                                                                value="{{ $p->id }}" id="{{ $p->id }}"
                                                                form="multiForm" class="form-check-input checkbox">
                                                        </td>
                                                        ...
                                                        <td class="text-start text-nowrap">{{ $p->lower_price }} -
                                                            {{ $p->upper_price }}</td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex justify-content-center align-items-center">
                                                                <div class="mx-1">
                                                                    <a href="{{ route('project.detail', $p->id) }}"
