                                ...
                                <div
                                                ...
                                                <label for="amenity" class="form-label w-100">
                                                    ...
                                                    <select id="amenity"
                                                        ...
                                                        @foreach ($amenity as $key => $am)
                                                            <option value="{{ $am->id }}"
                                                                @if (old('amenity')) {{ collect(old('amenity'))->contains($am->id) ? 'selected' : '' }}>
                                                        {{ $am->amenity }}
                                                    </option>
                                                    @else
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea id="map_link" maxlength="300" class="form-control create-textarea text-white fs-6 fw-light is-invalid"
                                                name="map_link" id="" cols="30" rows="6" placeholder="Map Link" disabled>{{ old('map_link', $project->gmlink) }}</textarea>
                                        </div>
                                        <!-- description -->
                                        <div class="mb-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <textarea id="project_description" class="form-control create-textarea text-white fs-6 fw-light" name="description"
                                                cols="30" rows="10" style="white-space: normal" disabled>{{ old('description', $project->description) }}</textarea>
                                        </div>
                                            ...
                                            <div class="col-2 px-0">
                                                <div id="siteprogressId"
                                                    ...
                                                    style="width:100%;cursor:pointer">
                                                     @if (count($project->siteProgressesImage) > 0)
                                                            @php
                                                                $lastImage = $project->siteProgressesImage->last();
                                                            @endphp
                                                            <img src="{{ asset('storage/images/siteimages/' . $lastImage->image) }}" alt="" class="w-100 h-100">
                                                        @endif
