                                    ...
                                    <div class="mb-3">
                                        <div class="row row-cols-2">
                                            ...
                                            <div class="col">
                                                ...
                                                <input id="project_squreFeet" name="squre_feet" value="{{ old('squre_feet', $project->squre_feet) }}" type="number" class="create-input form-control form-control-lg rounded rounded-1  text-white mb-2 mb-md-0 fs-6" placeholder="652" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
