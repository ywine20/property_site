    ...
    <div class="row g-0 flex-column flex-md-row justify-content-center justify-content-md-start ">
        ...
        <div class="w-100 ">
            <div class="py-3 px-3">
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <a href="{{ route('project.edit', $project->slug) }}" title="edit" class="me-3">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input id="project_Id" name="project_Id" type="text"
                                        ...
                                        class="create-input form-control form-control-lg rounded rounded-1  text-white mb-2 mb-md-0 fs-6"
                                        disabled>
                                ...
                                <div class="mb-3">
                                    <label for="project_range_max" class="form-label">Range
                                        :</label>
                                    <div class="row row-cols-2">
                                        <div class="col">
                                            <input id="project_range_min" name="lower_price"
                                                value="{{ old('lower_price', $project->lower_price) }}" type="number"
                                                class="create-input form-control form-control-lg rounded rounded-1  text-white mb-2 mb-md-0 fs-6"
                                                placeholder="Min" disabled>
                                        </div>
                                        <div class="col">
                                            <input id="project_range_max" name="upper_price"
                                                value="{{ old('upper_price', $project->upper_price) }}" type="number"
                                                class="create-input form-control form-control-lg rounded rounded-1  text-white mb-2 mb-md-0 fs-6"
                                ...
                                <<<<<<< HEAD </div>
                                    <div class="mb-3">
                                        <div class="row row-cols-2">
                                            <div class="col">
                                                <label for="project_floor" class="form-label">No.
                                                    of Units
                                                    :</label>
                                            ...
                                            <div class="col">
                                                <label for="project_squreFeet" class="form-label">Square
                                                    Feet
                                                    :</label>
                                                <input id="project_squreFeet" name="squre_feet"
                                                    value="{{ old('squre_feet', $project->squre_feet) }}" type="number"
                                                    class="create-input form-control form-control-lg rounded rounded-1  text-white mb-2 mb-md-0 fs-6"
                                                    placeholder="652" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="project_ward" class="form-label">Ward
                                            :</label>
                                        <input id="project_ward" name="ward" value="{{ old('ward', $project->ward) }}"
                                            type="text"
                                            ...
                                            placeholder="ward" disabled>
                                    </div>
                                    <div class="mb-3">
                                        <label for="project_street" class="form-label">Street
                                            :</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="project_houseNo" class="form-label">House
                                            No :</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="project_houseNo" class="form-label">Progress
                                            :</label>
                                    ...
                                    <div class="mb-3">
                                        <div class="w-100">
                                            <label for="amenity" class="form-label w-100">
                                                ...
                                                <select id="amenity"
                                                    ...
                                                    name="amenity[]" multiple="multiple" style="width: 100%" disabled>
                                                    @foreach
                                                    ($amenity as
                                                    $key => $am)
                                                    <option value="{{ $am->id }}" @if (old('amenity'))
                                                        {{ collect(old('amenity'))->contains($am->id) ? 'selected' : '' }}>
                                                        {{ $am->amenity }}
                                                    </option>
                                                    =======
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="w-100">
                                                            <label for="amenity" class="form-label w-100">
                                                                ...
                                                                <select id="amenity"
                                                                    class="amenity-multiple form-select create-select w-100"
                                                                    name="amenity[]" multiple="multiple"
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <div class="mb-3">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <label for="map_link" class="form-label">Map
                                                        Link
                                                        :</label>
                                                </div>
                                                <textarea id="map_link" maxlength="300"
                                                    class="form-control create-textarea text-white fs-6 fw-light is-invalid"
                                                    name="map_link" id="" cols="30" rows="6" placeholder="Map Link"
                                                    disabled>{{ old('map_link', $project->gmlink) }}</textarea>
                                            </div>
                                            <!-- description -->
                                            <div class="mb-3">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <label for="project_description" class="form-label">Description
                                                        :</label>
                                                </div>
                                                <textarea id="project_description"
                                                    class="form-control create-textarea text-white fs-6 fw-light"
                                                    name="description" cols="30" rows="10" style="white-space: normal"
                                                    disabled>{{ old('description', $project->description) }}</textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-5">
                                                        <div class="project-cover-preview w-100 overflow-hidden">
                                                            <label for="project_cover_input" class="form-label">Cover
                                                                Image
                                                                :</label>
                                                            ...
                                                            <div id="cover-preview"
                                                                class="bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview "
                                                                style="height:300px;">
                                                    ...
                                                    <div class="col-7">
                                                        <div class="project-cover-preview w-100 overflow-hidden">
                                                            <label for="project_360_input" class="form-label">360
                                                                Image
                                                                :</label>
                                                            <input type="file" class="form-control d-none"
                                                                value="{{ $project->threeSixtyImage }}"
                                                                name="threeSixtyImage" id="project_360_input" disabled>
                                                            <div id="360-preview"
                                                                class="three-preview bg-secondary bg-opacity-50 cursor-pointer d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview  "
                                                                style="height:300px;">
                                                ...
                                                <div class="col-12 col-lg-6">
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <label for="map_link" class="form-label">Map Link
                                                                :</label>
                                                        </div>
                                                        <<<<<<< HEAD <div class="row row-cols-auto g-2 my-3">
                                                            <!-- small image 1 -->
                                                            <div class="col">
                                                                <input type="file" name="small_img_1"
                                                                    class="form-control d-none small_file"
                                                                    id="small_img_input_1" disabled>
                                                                <div id=""
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div id=""
                                                                    ...
                                                                    <textarea id="map_link" maxlength="300"
                                                                        class="form-control create-textarea text-white fs-6 fw-light is-invalid"
                                                                        name="map_link" id="" cols="30" rows="6"
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-5">
                                                                            <div
                                                                                class="project-cover-preview w-100 overflow-hidden">
                                                                                <label for="project_cover_input"
                                                                                ...
                                                                                <input type="file" name="cover"
                                                                                    ...
                                                                                    value="{{ $project->cover }}"
                                                                                    id="project_cover_input" disabled>
                                                                                <div id="cover-preview"
                                                                                    class="bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview "
                                                                                    style="height:300px;">
                                                                                    <img src="{{ asset('storage/images/cover/' . $project->cover) }}"
                                                                                ...
                                                                                <small
                                                                                    class="text-warning fw-light d-none">
                                                                                    max : 2
                                                                                    MB |
                                                                                    width=600
                                                                                    |
                                                                        ...
                                                                        <div class="col-7">
                                                                            <div
                                                                                class="project-cover-preview w-100 overflow-hidden">
                                                                                <label for="project_360_input"
                                                                                    class="form-label">360
                                                                                    Image
                                                                                    :</label>
                                                                                <input type="file"
                                                                                    class="form-control d-none"
                        ...
                        <div class="col text-center">
                            <a href="{{route('albumTest.create',$project->id)}}">
                                <div id="album_create"
                                    ...
                                    <img src="{{asset('/images/addPlaceholder.png')}}" id="" alt="" class="w-100 h-100"
                        ...
                        <div class="col text-center">
                            <a href="{{ route('albumTest.show', ['projectId' => $project->id, 'id' => $album->id]) }}"
                                ...
                                <div id="album1"
                                    ...
                                    ||
                                    $extension == 'gif')
                                    <img src="{{ asset('storage/images/album/'.$lastImage->image) }}" id="" alt=""
                            ...
                            <div class="row progressCard bg-secondary d-flex flex-row rounded rounded-3 overflow-hidden"
                                ...
                                <div class="col-2 px-0">
                                    <div id="siteprogressId"
                                        ...
                                        echo '<img src="'.$lastImage.'" id="" alt="" class="w-100 h-100"
                                                ...
                                                <small>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="mt-5">
                                                            <div
                                                                class="d-flex justify-content-between align-items-center">
                                                                <label for="gallery_image_files"
                                                                    class="form-label">Gallery Images
                                                                    :</label>
                                                                <small class="text-warning fw-light d-none">
                                                        ...
                                                        <<<<<<< HEAD <div class="card-title fw-bold text-primary mb-3"
                                            ...
                                            <div class="col text-center">
                                                <a href="{{ route('project.detail', $project->id) }}">
                                                    <div id="album1"
                                                        ...
                                                        style="width:150px;height:150px;cursor:pointer">
                                                        <img src="{{ asset('storage/images/cover/' . $project->cover) }}"
                                                            id="" alt="" class="w-100 h-100" style="object-fit: cover">
                                                    </div>
                                                ...
                                                <div class="row progressCard bg-secondary d-flex flex-row rounded rounded-3 overflow-hidden"
                                                    ...
                                                    <div class="col-2 px-0">
                                                        <div id="siteprogressId"
                                                            ...
                                                            @foreach ($project->siteProgressesImage as $key
                                                            => $image)
                                                            @if ($key == 0)
                                                    ...
                                                    <div
                                                        class="col-10 d-flex align-items-baseline justify-content-start py-2">
                ...
                @section('script')
                <<<<<<< HEAD <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js"
