                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <a href="{{ route('project.edit', $project->slug) }}"
                                        class="btn  edit-icon px-2 py-1 fs-4">
                                ...
                                <div class="col-8 col-md-6 col-lg-5 col-xl-3">
                                    <div class="d-flex justify-content-center justify-content-lg-end">
                                        <div class="w-100 overflow-hidden rounded coverImage">
                                            <img src="{{ asset('images/projects/' . $project->cover) }}" alt=""
                                        ...
                                        <table class="table table-borderless project-detail-table">
                                            <tbody class="">
                                                ...
                                                <tr class="" style="background-color: transparent !important;">
                                                    ...
                                                    <td class="text-white py-3">
                                                        <span
                                                            class="text-white d-flex align-items-center justify-content-start flex-wrap">
                                                ...
                                                <tr class="" style="background-color: transparent !important;">
                                                    ...
                                                    <td class="text-white py-3 " style="max-width:150px">
                                                        <div class="text-white text-break">
                                                            ...
                                                            <div class="overflow-hidden bg-black rounded mt-2"
                                                                style="width: 400px;height: 300px;">
                                                                <iframe src="{{ $project->gmlink }}"
                                                        ...
                                                        <div class="text-white text-break">
                                                            <div class="">
                                                                <div class="overflow-hidden bg-black rounded"
                                                                    style="width: 400px;height: 300px;">
                                                                    <img src="/images/360images/{{ $project->gallery }}"
                                                ...
                                                <tr class="" style="background-color: transparent !important;">
                                                    ...
                                                    <td class="text-white py-3">
                                                        <div class="d-flex flex-wrap">
                                                            <div class="overflow-hidden bg-black rounded me-1 mb-1"
                                                                style="width: 150px;height: 150px;">
                                                                <img src="/images/gallery/{{ $project->previewimages->small_img1 }}"
                                                                    alt="" class="w-100 h-100"
                                                                    style="object-fit: cover">
                                                            </div>
                                                            <div class="overflow-hidden bg-black rounded me-1 mb-1"
                                                                style="width: 150px;height: 150px;">
                                                                <img src="/images/gallery/{{ $project->previewimages->small_img2 }}"
                                                                    alt="" class="w-100 h-100"
                                                                    style="object-fit: cover">
                                                            </div>
                                                            <div class="overflow-hidden bg-black rounded me-1 mb-1"
                                                                style="width: 150px;height: 150px;">
                                                                <img src="/images/gallery/{{ $project->previewimages->small_img3 }}"
                                                                    alt="" class="w-100 h-100"
                                                                    style="object-fit: cover">
                                                            </div>
                                                            <div class="overflow-hidden bg-black rounded me-1 mb-1"
                                                                style="width: 150px;height: 150px;">
                                                                <img src="/images/gallery/{{ $project->previewimages->small_img4 }}"
                                                                    alt="" class="w-100 h-100"
                                                                    style="object-fit: cover">
                                                            </div>
                                                            <div class="overflow-hidden bg-black rounded me-1 mb-1"
                                                                style="width: 150px;height: 150px;">
                                                                <img src="/images/gallery/{{ $project->previewimages->small_img5 }}"
                                                                    alt="" class="w-100 h-100"
                                                                    style="object-fit: cover">
                                                            </div>
                                                            <div class="overflow-hidden bg-black rounded me-1 mb-1"
                                                                style="width: 150px;height: 150px;">
                                                                <img src="/images/gallery/{{ $project->previewimages->small_img6 }}"
                                                                    alt="" class="w-100 h-100"
                                                                    style="object-fit: cover">
                                                            </div>
                                                            <div class="overflow-hidden bg-black rounded me-1 mb-1"
                                                                style="width: 150px;height: 150px;">
                                                                <img src="/images/gallery/{{ $project->previewimages->small_img7 }}"
                                                                    alt="" class="w-100 h-100"
                                                                    style="object-fit: cover">
                                                            </div>
                                                            <div class="overflow-hidden bg-black rounded me-1 mb-1"
                                                                style="width: 150px;height: 150px;">
                                                                <img src="/images/gallery/{{ $project->previewimages->small_img8 }}"
                                                                    alt="" class="w-100 h-100"
                                                                    style="object-fit: cover">
                                                            </div>
                                                            <div class="overflow-hidden bg-black rounded me-1 mb-1"
                                                                style="width: 150px;height: 150px;">
                                                                <img src="/images/gallery/{{ $project->previewimages->small_img9 }}"
                                                                    alt="" class="w-100 h-100"
                                                                    style="object-fit: cover">
                                                            </div>
                                                        </div>
