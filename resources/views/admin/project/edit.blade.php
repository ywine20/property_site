                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="category_id" class="create-select form-select form-select-lg fs-6 text-white rounded rounded-1 c mb-2 mb-md-0" id="project_category">
                                            ...
                                            <option value="{{$c->category_id}}" {{ $c->category_id == old('category_id',$project->category_id) ? 'selected':'' }}>{{$c->category_name}}
                                            </option>
                                    ...
                                    <div class="mb-3">
                                        <div class="mt-5">
                                            ...
                                            <div class="row row-cols-5 g-2 my-3">
                                                ...
                                                <div class="col">
                                                    <input type="file" name="" class="form-control d-none small_file" id="small_img_input_2">
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
                                                ...
                                                <div class="col">
                                                    <input type="file" name="" class="form-control d-none small_file" id="small_img_input_3">
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
                                                ...
                                                <div class="col">
                                                    <input type="file" name="" class="form-control d-none small_file" id="small_img_input_4">
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
                                                ...
                                                <div class="col">
                                                    <input type="file" name="" class="form-control d-none small_file" id="small_img_input_5">
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
                                                ...
                                                <div class="col">
                                                    <input type="file" name="" class="form-control d-none small_file" id="small_img_input_6">
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
                                                ...
                                                <div class="col">
                                                    <input type="file" name="" class="form-control d-none small_file" id="small_img_input_7">
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
                                                ...
                                                <div class="col">
                                                    <input type="file" name="" class="form-control d-none small_file" id="small_img_input_8">
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
                                                ...
                                                <div class="col">
                                                    <input type="file" name="" class="form-control d-none small_file" id="small_img_input_9">
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
