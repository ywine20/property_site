    ...
    <div class="content">
                                        ...
                                        <div class="mb-3">
                                            <div class="w-100">
                                                <div class="project-cover-preview w-100 overflow-hidden">
                                                    ...
                                                    <input type="file" id="price_img_input" name="priceImage"
                                                        class="create-input form-control @error('priceImage') is-invalid @enderror">
                                                ...
                                                <div class="priceImagePreview">
                                                    <div class=" bg-white overflow-hidden w-auto py-2 mt-2"
                                                        style="height:250px;max-width:70%;{{ $project->priceImg ? 'display:block' : 'display:none' }}">
                                                        <img id="price_img"
                                                            src="{{ asset('storage/images/priceImg/' . $project->priceImg) }}"
                                                ...
                                                <div class="col-5">
                                                    <div class="project-cover-preview w-100 overflow-hidden">
                                                        ...
                                                        <div id="cover-preview"
                                                            ...
                                                            style="height:300px;">
                                                            <img src="{{ asset('storage/images/cover/' . $project->cover) }}"
                                                ...
                                                <div class="col-7">
                                                    <div class="project-cover-preview w-100 overflow-hidden">
                                                        ...
                                                        <input type="file" class="form-control d-none"
                                                            value="{{ $project->threeSixtyImage }}"
                                                            name="threeSixtyImage" id="project_360_input">
                                                        <div id="360-preview"
                                                            class="three-preview bg-secondary bg-opacity-50 cursor-pointer d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview  @error('threeSixtyImage') border border-danger @enderror"
                                                            style="height:300px;">
                                                            <img src="{{ $project->three_sixty_image ? asset('storage/images/360Images/' . $project->three_sixty_image) : asset('/images/photoPlaceholderWhite.png') }}"
                                        ...
                                        <div class="mb-3">
                                            <div class="mt-5">
                                                ...
                                                @if (
                                                    ...
                                                    <div class="text-danger fs-6 mt-2 alert alert-danger d-flex flex-column"
                                                        role="alert">
                                                        @error('small_img_1')
                                                            <span>{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="row row-cols-5 g-2 my-3">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div id=""
                                                            ...
                                                            <img src="{{ $project->previewimages->small_img1 ? asset('storage/images/gallery/' . $project->previewimages->small_img1) : asset('/images/photoPlaceholderWhite.png') }}"
                                                                id="sImg1" alt=""
                                                                class="w-100 h-100 pointer small_img"
                                                                style="object-fit: cover">

                                                            <button type="submit" form="del_small_img_1_form"
                                                                class="{{ $project->previewimages->small_img1 ? '' : 'none' }}"
                                                                id="del_small_img_1_btn">
                                                                <!-- del -->
                                                                <i
                                                    ...
                                                    <div class="col">
                                                        <input type="file" name="small_img_2"
                                                            ...
                                                            value="{{ $project->previewimages->small_img2 }}">
                                                        <div id=""
                                                            class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative"
                                                            style="width:100px;height:100px">
                                                            <img src="{{ $project->previewimages->small_img2 ? asset('storage/images/gallery/' . $project->previewimages->small_img2) : asset('/images/photoPlaceholderWhite.png') }}"
                                                                id="sImg2" alt=""
                                                                class="w-100 h-100 pointer small_img"
                                                                style="object-fit: cover">
                                                            <button type="submit" form="del_small_img_2_form"
                                                                class="{{ $project->previewimages->small_img2 ? '' : 'none' }}"
                                                                id="del_small_img_2_btn">
                                                                <!-- del -->
                                                                <i
                                                                    class="bi bi-x-circle-fill text-danger fw-bolder position-absolute top-0 end-0 me-1 pointer delImg"></i>
                                                            </button>
                                                    ...
                                                    <div class="col">
                                                        <input type="file" name="small_img_3"
                                                            ...
                                                            value="{{ $project->previewimages->small_img3 }}">
                                                        <div id=""
                                                            class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative"
                                                            style="width:100px;height:100px">
                                                            <img src="{{ $project->previewimages->small_img3 ? asset('storage/images/gallery/' . $project->previewimages->small_img3) : asset('/images/photoPlaceholderWhite.png') }}"
                                                                id="sImg3" alt=""
                                                                class="w-100 h-100 pointer small_img"
                                                                style="object-fit: cover">
                                                            <button type="submit" form="del_small_img_3_form"
                                                                class="{{ $project->previewimages->small_img3 ? '' : 'none' }}"
                                                                id="del_small_img_3_btn">
                                                                <!-- del -->
                                                                <i
                                                                    class="bi bi-x-circle-fill text-danger fw-bolder position-absolute top-0 end-0 me-1 pointer delImg"></i>
                                                            </button>
                                                    ...
                                                    <div class="col">
                                                        <input type="file" name="small_img_4"
                                                            ...
                                                            value="{{ $project->previewimages->small_img4 }}" />
                                                        <div id=""
                                                            class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative"
                                                            style="width:100px;height:100px">
                                                            <img src="{{ $project->previewimages->small_img4 ? asset('storage/images/gallery/' . $project->previewimages->small_img4) : asset('/images/photoPlaceholderWhite.png') }}"
                                                                id="sImg4" alt=""
                                                                class="w-100 h-100 pointer small_img"
                                                                style="object-fit: cover">
                                                            <button type="submit" form="del_small_img_4_form"
                                                                class="{{ $project->previewimages->small_img4 ? '' : 'none' }}"
                                                                id="del_small_img_4_btn">
                                                                <!-- del -->
                                                                <i
                                                                    class="bi bi-x-circle-fill text-danger fw-bolder position-absolute top-0 end-0 me-1 pointer delImg"></i>
                                                            </button>
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div id=""
                                                            class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative"
                                                            style="width:100px;height:100px">
                                                            <img src="{{ $project->previewimages->small_img5 ? asset('storage/images/gallery/' . $project->previewimages->small_img5) : asset('/images/photoPlaceholderWhite.png') }}"
                                                                id="sImg5" alt=""
                                                                class="w-100 h-100 pointer small_img"
                                                                style="object-fit: cover">
                                                            <button type="submit" form="del_small_img_5_form"
                                                                class="{{ $project->previewimages->small_img5 ? '' : 'none' }}"
                                                                id="del_small_img_5_btn">
                                                                <!-- del -->
                                                                <i
                                                                    class="bi bi-x-circle-fill text-danger fw-bolder position-absolute top-0 end-0 me-1 pointer delImg"></i>
                                                            </button>
                                                    ...
                                                    <div class="col">
                                                        <input type="file" name="small_img_6"
                                                            ...
                                                            value="{{ $project->previewimages->small_img6 }}">
                                                        <div id=""
                                                            class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative"
                                                            style="width:100px;height:100px">
                                                            <img src="{{ $project->previewimages->small_img6 ? asset('storage/images/gallery/' . $project->previewimages->small_img6) : asset('/images/photoPlaceholderWhite.png') }}"
                                                                id="sImg6" alt=""
                                                                class="w-100 h-100 pointer small_img"
                                                                style="object-fit: cover">
                                                            <button type="submit" form="del_small_img_6_form"
                                                                class="{{ $project->previewimages->small_img6 ? '' : 'none' }}"
                                                                id="del_small_img_6_btn">
                                                                <!-- del -->
                                                                <i
                                                                    class="bi bi-x-circle-fill text-danger fw-bolder position-absolute top-0 end-0 me-1 pointer delImg"></i>
                                                            </button>
                                                    ...
                                                    <div class="col">
                                                        <input type="file" name="small_img_7"
                                                            ...
                                                            value="{{ $project->previewimages->small_img7 }}">
                                                        <div id=""
                                                            class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative"
                                                            style="width:100px;height:100px">
                                                            <img src="{{ $project->previewimages->small_img7 ? asset('storage/images/gallery/' . $project->previewimages->small_img7) : asset('/images/photoPlaceholderWhite.png') }}"
                                                                id="sImg7" alt=""
                                                                class="w-100 h-100 pointer small_img"
                                                                style="object-fit: cover">
                                                            <button type="submit" form="del_small_img_7_form"
                                                                class="{{ $project->previewimages->small_img7 ? '' : 'none' }}"
                                                                id="del_small_img_7_btn">
                                                                <!-- del -->
                                                                <i
                                                                    class="bi bi-x-circle-fill text-danger fw-bolder position-absolute top-0 end-0 me-1 pointer delImg"></i>
                                                            </button>
                                                    ...
                                                    <div class="col">
                                                        <input type="file" name="small_img_8"
                                                            ...
                                                            value="{{ $project->previewimages->small_img8 }}">
                                                        <div id=""
                                                            class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative"
                                                            style="width:100px;height:100px">
                                                            <img src="{{ $project->previewimages->small_img8 ? asset('storage/images/gallery/' . $project->previewimages->small_img8) : asset('/images/photoPlaceholderWhite.png') }}"
                                                                id="sImg8" alt=""
                                                                class="w-100 h-100 pointer small_img"
                                                                style="object-fit: cover">
                                                            <button type="submit" form="del_small_img_8_form"
                                                                class="{{ $project->previewimages->small_img8 ? '' : 'none' }}"
                                                                id="del_small_img_8_btn">
                                                                <!-- del -->
                                                                <i
                                                                    class="bi bi-x-circle-fill text-danger fw-bolder position-absolute top-0 end-0 me-1 pointer delImg"></i>
                                                            </button>
                                                    ...
                                                    <div class="col">
                                                        <input type="file" name="small_img_9"
                                                            ...
                                                            value="{{ $project->previewimages->small_img9 }}">
                                                        <div id=""
                                                            class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative"
                                                            style="width:100px;height:100px">
                                                            <img src="{{ $project->previewimages->small_img9 ? asset('storage/images/gallery/' . $project->previewimages->small_img9) : asset('/images/photoPlaceholderWhite.png') }}"
                                                                id="sImg9" alt=""
                                                                class="w-100 h-100 pointer small_img"
                                                                style="object-fit: cover">
                                                            <button type="submit" form="del_small_img_9_form"
                                                                class="{{ $project->previewimages->small_img9 ? '' : 'none' }}"
                                                                id="del_small_img_9_btn">
                                                                <!-- del -->
                                                                <i
                                                                    class="bi bi-x-circle-fill text-danger fw-bolder position-absolute top-0 end-0 me-1 pointer delImg"></i>
                                                            </button>
                            ...
                            <div class="row row-cols-auto g-4 ">
                                <div class="col text-center">
                                    <a href="{{ route('albumTest.create', $project->id) }}">
                                        <div id="album_create"
                                            class="album bg-white bg-opacity-10 d-flex justify-content-center align-items-center rounded overflow-hidden rounded-4 position-relative shadow-lg"
                                            style="width:150px;height:150px;cursor:pointer;">
                                            <img src="{{ asset('/images/addPlaceholder.png') }}" id=""
                                                alt="" class="w-100 h-100"
                                                style="object-fit: cover;filter:invert(1)">
                                        </div>
                                ...
                                @foreach ($project->albumTests as $album)
                                    <div class="col text-center">
                                        <a href="{{ route('albumTest.show', ['projectId' => $project->id, 'id' => $album->id]) }}"
                                            title="Detail">
                                            <div id="album1"
                                                class="album bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded overflow-hidden rounded-4 position-relative shadow-lg"
                                                style="width:150px;height:150px;cursor:pointer">
                                                @if (count($album->albumTestImages) > 0)
                                                    ...
                                                    @if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'png' || $extension == 'gif')
                                                        <img src="{{ asset('storage/images/album/' . $lastImage->image) }}"
                                                            id="" alt="" class="w-100 h-100"
                                                            style="object-fit: cover">
                                                ...
                                                @else
                                                    <img src="{{ asset('images/photoPlaceholderWhite.png') }}"
                                                        id="" alt=""
                                                        class="w-100 h-100 bg-black bg-opacity-25"
                                                        style="object-fit: cover">
                                                @endif
                                        ...
                                        <div class="row progressCard bg-secondary d-flex flex-row rounded rounded-3 overflow-hidden"
                                            ...
                                            <div class="col-2 px-0  overflow-hidden " style="max-height:200px;">
                                                <div id="siteprogressId{{ $siteProgress->id }}"
                                                    class="siteprogressImage bg-white bg-opacity-50 d-flex justify-content-center align-items-center overflow-hidden position-relative w-100 h-100 "
                                            ...
                                            <div class="col-10 d-flex align-items-baseline justify-content-start py-2">
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex justify-content-start align-items-center">
                                                        <a href="{{ route('siteProgress.show', ['projectId' => $siteProgress->project_id, 'id' => $siteProgress->id]) }}"
                                                            class="btn btn-sm btn-outline-primary me-2">
                                                            <i class="bi bi-eye"></i>
                                                            Show Detail
                                                        </a>
                                                        <a href="{{ route('siteProgress.edit', ['projectId' => $siteProgress->project_id, 'id' => $siteProgress->id]) }}"
                                                            class="btn btn-sm btn-outline-primary me-2">
                                                            <i class="bi bi-pencil "></i>
                                                            Edit
                                                        </a>
                                                        <form method="post"
                                                            action="{{ route('siteProgress.destory', ['projectId' => $siteProgress->project_id, 'id' => $siteProgress->id]) }}">
                                                            @csrf
                                                            @method('DELETE')
        ...
        <section id="smallImageDeleteForm">
            ...
            @if ($project->previewimages->small_img1)
                <form
                    action="{{ route('previewImage.delete', ['name' => $project->previewimages->small_img1, 'fieldName' => 'small_img1']) }}"
                    method="post" id="del_small_img_1_form">
                    @csrf
                    @method('delete')
                </form>
            @endif
            ...
            @if ($project->previewimages->small_img2)
                <form
                    action="{{ route('previewImage.delete', ['name' => $project->previewimages->small_img2, 'fieldName' => 'small_img2']) }}"
                    method="post" id="del_small_img_2_form">
                    @csrf
                    @method('delete')
                </form>
            @endif
            ...
            @if ($project->previewimages->small_img3)
                <form
                    action="{{ route('previewImage.delete', ['name' => $project->previewimages->small_img3, 'fieldName' => 'small_img3']) }}"
                    method="post" id="del_small_img_3_form">
                    @csrf
                    @method('delete')
                </form>
            @endif
            ...
            @if ($project->previewimages->small_img4)
                <form
                    action="{{ route('previewImage.delete', ['name' => $project->previewimages->small_img4, 'fieldName' => 'small_img4']) }}"
                    method="post" id="del_small_img_4_form">
                    @csrf
                    @method('delete')
                </form>
            @endif
            ...
            @if ($project->previewimages->small_img5)
                <form
                    action="{{ route('previewImage.delete', ['name' => $project->previewimages->small_img5, 'fieldName' => 'small_img5']) }}"
                    method="post" id="del_small_img_5_form">
                    @csrf
                    @method('delete')
                </form>
            @endif
            ...
            @if ($project->previewimages->small_img6)
                <form
                    action="{{ route('previewImage.delete', ['name' => $project->previewimages->small_img6, 'fieldName' => 'small_img6']) }}"
                    method="post" id="del_small_img_6_form">
                    @csrf
                    @method('delete')
                </form>
            @endif
            ...
            @if ($project->previewimages->small_img7)
                <form
                    action="{{ route('previewImage.delete', ['name' => $project->previewimages->small_img7, 'fieldName' => 'small_img7']) }}"
                    method="post" id="del_small_img_7_form">
                    @csrf
                    @method('delete')
                </form>
            @endif
            ...
            @if ($project->previewimages->small_img8)
                <form
                    action="{{ route('previewImage.delete', ['name' => $project->previewimages->small_img8, 'fieldName' => 'small_img8']) }}"
                    method="post" id="del_small_img_8_form">
                    @csrf
                    @method('delete')
                </form>
            @endif
            ...
            @if ($project->previewimages->small_img9)
                <form
                    action="{{ route('previewImage.delete', ['name' => $project->previewimages->small_img9, 'fieldName' => 'small_img9']) }}"
                    method="post" id="del_small_img_9_form">
                    @csrf
                    @method('delete')
                </form>
            @endif
...
@section('script')
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js" price_img
    ...
    <script>
            ...
            axios.delete(smallImgOneForm.action, {}).then(response => {
                if (response.data.status == '1') {
                    document.getElementById('sImg1').src =
                        '{{ asset('storage/images/photoPlaceholderWhite.png') }}';
        ...
        smallImgTwoForm.addEventListener('submit', (e) => {
            ...
            axios.delete(smallImgTwoForm.action, {}).then(response => {
                if (response.data.status == '1') {
                    document.getElementById('sImg2').src =
                        '{{ asset('storage/images/photoPlaceholderWhite.png') }}';
        ...
        smallImgThreeForm.addEventListener('submit', (e) => {
            ...
            axios.delete(smallImgThreeForm.action, {}).then(response => {
                if (response.data.status == '1') {
                    document.getElementById('sImg3').src =
                        '{{ asset('storage/images/photoPlaceholderWhite.png') }}';
        ...
        smallImgFourForm.addEventListener('submit', (e) => {
            ...
            axios.delete(smallImgFourForm.action, {}).then(response => {
                if (response.data.status == '1') {
                    document.getElementById('sImg4').src =
                        '{{ asset('storage/images/photoPlaceholderWhite.png') }}';
        ...
        smallImgFiveForm.addEventListener('submit', (e) => {
            ...
            axios.delete(smallImgFiveForm.action, {}).then(response => {
                if (response.data.status == '1') {
                    document.getElementById('sImg5').src =
                        '{{ asset('storage/images/photoPlaceholderWhite.png') }}';
        ...
        smallImgSixForm.addEventListener('submit', (e) => {
            ...
            axios.delete(smallImgSixForm.action, {}).then(response => {
                if (response.data.status == '1') {
                    document.getElementById('sImg6').src =
                        '{{ asset('storage/images/photoPlaceholderWhite.png') }}';
        ...
        smallImgSevenForm.addEventListener('submit', (e) => {
            ...
            axios.delete(smallImgSevenForm.action, {}).then(response => {
                if (response.data.status == '1') {
                    document.getElementById('sImg7').src =
                        '{{ asset('storage/images/photoPlaceholderWhite.png') }}';
        ...
        smallImgEightForm.addEventListener('submit', (e) => {
            ...
            axios.delete(smallImgEightForm.action, {}).then(response => {
                if (response.data.status == '1') {
                    document.getElementById('sImg8').src =
                        '{{ asset('storage/images/photoPlaceholderWhite.png') }}';
        ...
        smallImgNineForm.addEventListener('submit', (e) => {
            ...
            axios.delete(smallImgNineForm.action, {}).then(response => {
                if (response.data.status == '1') {
                    document.getElementById('sImg9').src =
                        '{{ asset('storage/images/photoPlaceholderWhite.png') }}';
