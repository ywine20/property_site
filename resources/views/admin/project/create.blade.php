                            ...
                            <div class="row gx-3 d-flex flex-column flex-md-row justify-content-start align-items-start">
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="category" class="create-select form-select form-select-lg fs-6 text-white rounded rounded-1 c mb-2 mb-md-0" id="project_category">
                                            ...
                                            <option {{ $c->category_id == old('category') ? 'selected':'' }} value="{{$c->category_id}}"> {{$c->category_name}}</option>
                                            @endforeach
                                        </select>
                                        @error('category')
                                        ...
                                        <div class="row row-cols-1 row-cols-md-2">
                                            <div class="col">
                                                <select name="city_slug" class="create-select form-select form-select-lg fs-6 text-white rounded rounded-1 c mb-2 mb-md-0" id="project_city">
                                                    ...
                                                    @foreach ($cities as $c)
                                                    <option value="{{$c->slug}}" {{ $c->slug == old('city_slug') ? 'selected':'' }}>{{$c->name}}</option>
                                                    @endforeach
                                                </select>
                                                @error('city_slug')
                                            ...
                                            <div class="col">
                                                <select name="town_slug" class="create-select form-select form-select-lg fs-6 text-white rounded rounded-1 c mb-2 mb-md-0" id="project-township">
                                                    ...
                                                    @foreach ($towns as $t)
                                                    <option value="{{$t->slug}}" {{ $t->slug == old('town_slug') ? 'selected':'' }}>{{$t->name}}</option>
                                                    @endforeach
                                                </select>
                                                @error('town_slug')
                                                <div class="text-danger fs-6" role="alert">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <label for="amenity" class="form-label w-100">
                                                ...
                                                <select id="amenity" class="amenity-multiple form-select create-select w-100" name="amenity[]" multiple="multiple" style="width: 100%" required>
                                                    ...
                                                    <option value="{{$am->id}}" {{ (collect(old('amenity'))->contains($am->id)) ? 'selected':'' }}>{{$am->amenity}}</option>
                                                    @endforeach
                                                </select>
                                            </label>
                                            @error('amenity')
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea id="map_link" maxlength="300" value="{{old('map_link')}}" class="form-control create-textarea text-white fs-6 is-invalid" name="map_link" id="" cols="30" rows="6" style="" placeholder="Map Link">{{old('map_link')}}</textarea>
                                        @error('map_link')
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="project-cover-preview w-100 overflow-hidden">
                                                    <label for="project_cover_input" class="form-label">Cover Image :</label>
                                                    ...
                                                    <div id="cover-preview" class="bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview" style="height:300px;">
                                                        <img src="../../images/photoPlaceholderWhite.png" id="cover_img" alt="" class="w-100 h-100" style="object-fit: cover">
                                            ...
                                            <div class="col-7">
                                                <div class="project-360-preview w-100 overflow-hidden">
                                                    <label for="project_360_input" class="form-label">360 Image :</label>
                                                    <input type="file" name="gallery" class="form-control d-none" id="project_360_input">
                                                    <div id="360-preview" class="three-preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview " style="height:300px;">
                                                        <img src="../../images/photoPlaceholderWhite.png" id="360_img" alt="" class="w-100 h-100" style="object-fit: cover">
                                                        <!--                                                                <i class="bi bi-camera-fill fa-fw fa-3x text-secondary"></i>-->
                                                    </div>
                                                    <small class="text-warning fw-light">
                                                        max : 2.5 MB
                                            ...
                                            <div class="row row-cols-5 g-2 my-3">
                                                <div class="col">
                                                    ...
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
                                                        <img src="../../images/photoPlaceholderWhite.png" id="sImg1" alt="" class="w-100 h-100 pointer small_img" style="object-fit: cover">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
                                                        <img src="../../images/photoPlaceholderWhite.png" id="sImg2" alt="" class="w-100 h-100 pointer small_img " style="object-fit: cover">
                                                        <i class="bi bi-x-circle-fill text-danger fw-bolder position-absolute top-0 end-0 me-1 pointer delImg"></i>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    ...
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
                                                        <img src="../../images/photoPlaceholderWhite.png" id="sImg3" alt="" class="w-100 h-100 pointer small_img " style="object-fit: cover">
                                                        <i class="bi bi-x-circle-fill text-danger fw-bolder position-absolute top-0 end-0 me-1 pointer delImg"></i>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    ...
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
                                                        <img src="../../images/photoPlaceholderWhite.png" id="sImg4" alt="" class="w-100 h-100 pointer small_img " style="object-fit: cover">
                                                        <i class="bi bi-x-circle-fill text-danger fw-bolder position-absolute top-0 end-0 me-1 pointer delImg"></i>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    ...
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
                                                        <img src="../../images/photoPlaceholderWhite.png" id="sImg5" alt="" class="w-100 h-100 pointer small_img " style="object-fit: cover">
                                                        <i class="bi bi-x-circle-fill text-danger fw-bolder position-absolute top-0 end-0 me-1 pointer delImg"></i>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    ...
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
                                                        <img src="../../images/photoPlaceholderWhite.png" id="sImg6" alt="" class="w-100 h-100 pointer small_img " style="object-fit: cover">
                                                        <i class="bi bi-x-circle-fill text-danger fw-bolder position-absolute top-0 end-0 me-1 pointer delImg"></i>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    ...
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
                                                        <img src="../../images/photoPlaceholderWhite.png" id="sImg7" alt="" class="w-100 h-100 pointer small_img " style="object-fit: cover">
                                                        <i class="bi bi-x-circle-fill text-danger fw-bolder position-absolute top-0 end-0 me-1 pointer delImg"></i>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    ...
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
                                                        <img src="../../images/photoPlaceholderWhite.png" id="sImg8" alt="" class="w-100 h-100 pointer small_img " style="object-fit: cover">
                                                        <i class="bi bi-x-circle-fill text-danger fw-bolder position-absolute top-0 end-0 me-1 pointer delImg"></i>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    ...
                                                    <div id="" class="small_img_preview bg-secondary bg-opacity-50 d-flex justify-content-center align-items-center rounded is-invalid overflow-hidden image-preview position-relative" style="width:100px;height:100px">
                                                        <img src="../../images/photoPlaceholderWhite.png" id="sImg9" alt="" class="w-100 h-100 pointer small_img " style="object-fit: cover">
                                                        <i class="bi bi-x-circle-fill text-danger fw-bolder position-absolute top-0 end-0 me-1 pointer delImg"></i>
                                                    </div>
                                                </div>
                                            </div>
