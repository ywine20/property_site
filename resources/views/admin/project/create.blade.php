                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea id="project_description"
                                                class="form-control create-textarea text-white fs-6 @error('description') is-invalid @enderror" name="description"
                                                ...
                                                <div class="col-5">
                                                    <div class="project-cover-preview w-100 overflow-hidden">
                                                        ...
                                                        <div id="cover-preview"
                                                            ...
                                                            style="height:300px;">
                                                            <img src="../../images/photoPlaceholderWhite.png"
                                                ...
                                                <div class="col-7">
                                                    <div class="project-360-preview w-100 overflow-hidden">
                                                        <label for="project_360_input" class="form-label">360 Image
                                                            :</label>
                                                        <input type="file" name="gallery" class="form-control d-none"
