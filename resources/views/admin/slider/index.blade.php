                        ...
                        <div class="card bg-secondary table-card">
                            <div class="card-body">
                                <div class="w-100 table-responsive-sm">
                                    <table id="table_SliderImage" class="w-100 display nowrap row-border table table-bordered align-middle table-hover mb-0">
                                        <thead class="">
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex justify-content-center align-items-center">
                                                    <div class="slider-photo rounded overflow-hidden">
                                                        ...
                                                        @else
                                                        <img src="{{ asset('/images/photoPlaceholderWhite.png') }}" alt="">
                                                        @endif
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <div class="mx-1">
                                                            <a href="{{ route('slider.edit', $item->id) }}" class="  edit-icon px-2 py-1">
