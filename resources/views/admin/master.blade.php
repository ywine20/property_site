            ...
            <aside class="vh-100 bg-secondary aside-hide ">
                ...
                <div id="side" class="bg-secondary w-100 my-3">
                    <ul class="list-unstyled">
                        ...
                        <a class="side-link  w-100 {{ Request::is('admin/customers*') ? 'active' : '' }}" href="{{ route('admin.customersList') }}" style="text-decoration: none;">
                            <li class="py-3 side-item px-3">
                                Customers
                            </li>
                        </a>
                        ...
                        <a class="side-link  w-100 {{ Request::is('admin/redeemCodes*') ? 'active' : '' }}" href="{{ route('admin.generateRedeemCodePage') }}" style="text-decoration: none;">
                            <li class="py-3 side-item px-3">
                                Redeem Code
                            </li>
                        </a>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="profile d-flex align-items-center pe-2 text-primary" style="min-width: max-content;">
                                <div class="overflow-hidden rounded rounded-circle  dropdown-toggle border border-primary border-opacity-50" data-bs-toggle="dropdown" data-bs-offset="20,20" style="width:50px;height:50px;cursor:pointer">
                                    @auth('admin')
                                        ...
                                        <div class="card bg-secondary text-primary px-2 py-2" style="max-width: 500px">
                                            ...
                                            <div class="d-flex justify-content-start align-items-center my-3 px-3">
                                                ...
                                                <div class="ps-3">
                                                    ...
                                                    <a href="{{ url('/admin/user') }}" class="text-decoration-underline fw-light">View
                                                        Detail</a>
                                                </div>
                                            </div>
                                        </div>
