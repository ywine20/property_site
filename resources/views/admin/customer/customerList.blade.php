            ...
            <div class="row g-0 flex-column flex-md-row justify-content-center justify-content-md-start ">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('export.create') }}" class="btn btn-outline-primary">Export
                            <i class="bi bi-file-earmark-arrow-down-fill"></i>
                        </a>

                        {{-- <button class="btn btn-primary btn-lg text-white rounded rounded-1">Exprot</button> --}}
                    </div>
                </div>
                <div class="col-12 d-none">
                    <div class="d-flex justify-content-start align-items-center bg-secondary bg-opacity-50 rounded px-3 py-1 ">
                        <ul class="d-flex justify-content-start text-primary align-items-center mt-3" style="list-style: none">
                                        ...
                                        <tbody class="bg-secondary text-white">
                                            ...
                                            <tr id="row{{$customer->id}}">
                                                <td class="text-center">
                                                    <input type="checkbox" name="chk[]" value="{{$customer->id}}" id="{{$customer->id}}" form="multiForm" class="form-check-input checkbox">
                                                </td>
                                                <th scope="row" class="text-center">{{++$keys}}</th>
                                                <td class="text-start text-nowrap text-uppercase">
                                                    <div class="rounded rounded-circle overflow-hidden shadow" style="width:45px;height:45px;">
                                                        @if($customer->profile_img)
                                                        <img src="{{asset('storage/images/client-profile/'.$customer->profile_img)}}" alt="" class="w-100 h-100" style="object-fit:cover">
                                                        @else
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <div class="mx-1">
                                                            <a href="{{route('admin.customerDetail',$customer->id)}}" class="  info-icon px-2 py-1">
