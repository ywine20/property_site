                                                ...
                                                <table id="table_Project" class="w-100 display nowrap row-border table table-bordered align-middle table-hover mb-0">
                                                    ...
                                                    <tr id="row{{$customer->id}}">
                                                        ...
                                                        <td class="text-start text-nowrap text-uppercase">
                                                            <div class="rounded rounded-circle overflow-hidden" style="width:45px;height:45px;">
                                                        ...
                                                        <td >
                                                            <div class="d-flex justify-content-center align-items-center">
                                                                <div class="mx-1">
                                                                    <a href="{{ route('project.detail',$customer->id) }}"  class="  info-icon px-2 py-1">
                                                                        <i class="bi bi-info-circle text-info fa-fw"></i>
                                                                    </a>
                                                                </div>
                                                                {{-- <div class="mx-1">
                                                                    <a href="{{ route('project.edit',$customer->slug) }}"  class="btn  edit-icon px-2 py-1">
