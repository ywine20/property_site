        ...
        <div class="bg-secondary bg-opacity-50 px-2 py-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active">Township_create</li>
                ...
                <div class="row create flex-column">
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="mb-3 text-primary header">Township Create</h4>
                    ...
                    <div class="col-12 col-md-8 col-lg-6 ">
                        <div class="mb-5">
                            <form action="{{url('admin/add-town')}}" class="create-form" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row gx-1 d-flex flex-column flex-md-row justify-content-start align-items-start">
                                    ...
                                    <div class="col-12 col-md-8">
                                        <input type="text" required autofocus id="townShip" name="name" class="create-input form-control form-control-lg rounded rounded-1  text-white mb-2 mb-md-0 @error('name') is-invalid @enderror" placeholder="Township">
                                        @error('name')
