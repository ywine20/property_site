                            ...
                            <div class="row create">
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h4 class="mb-3 text-primary header">Facebook Link Create</h4>
                                ...
                                <div class="col-12 col-md-12 col-lg-12">
                                    <form action="{{ route('facebooklink.store') }}" method="POST" enctype="multipart/form-data" class="facebook-create-form create-form">
                                       @csrf
                                                ...
                                                <div class="row">
                                                   <div class="col-12">
                                                      <div class="mb-3">
                                                          ...
                                                          <input type="text" required id="facebook_Link" value="{{old('project_post_link')}}" name="project_post_link" class="create-input form-control form-control-lg rounded rounded-1 text-white mb-2 mb-md-0 fs-6 @error('project_post_link') is-invalid @enderror" placeholder="https://www.facebook.com/2345678">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea id="facebook_description" required maxlength="300" class="form-control create-textarea text-white fs-6 @error('description') is-invalid @enderror" name="description" id="" cols="30" rows="6">{{old('description')}}</textarea>
                                                            @error('description')
                                                                <div class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </div>
                                                ...
                                                <div class="row d-flex justify-content-center align-items-center">
                                                    <div class="col-12 d-flex justify-content-center align-items-center  ps-lg-5">
                                                        <div class="facebook-preview w-100 overflow-hidden">
                                                            <label for="facebook_description" class="form-label text-white">
                                                                Facebook Preview Image  :
                                                               
                                                            </label>
                                                            <input type="file" name="picture" accept='image/*' class="form-control d-none" id="facebook-image-input">
                                                            <div id="facebook-image-preview" class="d-flex justify-content-center align-items-center rounded is-invalid image-preview @error('picture') border border-danger  @enderror" >
                                                                <img src="../../images/photoPlaceholderWhite.png" id="fb-img"  alt="" >
