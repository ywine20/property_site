                            ...
                            <form method="POST"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="title"
                                        class="create-input form-control @error('title') is-invalid @enderror"
                                        id="title" value="{{ old('title', $siteProgress->title) }}" required>
                                    @error('title')
                                ...
                                <div class="form- mb-3">
                                    ...
                                    <textarea type="text" name="description" rows="10"
                                        class="create-input form-control @error('description') is-invalid @enderror" id="description" required>{{ old('description', $siteProgress->description) }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
