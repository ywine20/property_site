...
<head>
  ...
  <link rel="icon" href="<?php echo e(asset('image/smtlogo.png')); ?>" type="image/png">
  ...
  <meta property="og:image" content="<?php echo e(asset('image/smtlogoLarge.png')); ?>">
  ...
  <meta property="twitter:image" content="<?php echo e(asset('image/smtlogoLarge.png')); ?>">
  ...
  <div class="container-fluid p-0">
      ...
      <div class="offcanvas-body ">
        <div class="offcanvas-header">
          <div class="d-flex justify-content-between align-items-center w-100 bg-secondary">
            <img src="<?php echo e(asset('image/smtlogo.png')); ?>" alt="" style="width:50px;height:auto">
        ...
        <ul class="side-nav-ul list-group me-auto mb-2 mb-lg-0">
          <li class="side-nav-item">
            <a class="side-nav-link nav-link px-2 py-3" aria-current="page" href="<?php echo e(url('/')); ?>">Home</a>
          </li>
          <li class="side-nav-item">
            <a class="side-nav-link nav-link px-2 py-3" aria-current="page" href="<?php echo e(url('projectlist')); ?>">Projects</a>
          </li>
          <li class="side-nav-item">
            <a class="side-nav-link nav-link px-2 py-3" aria-current="page" href="<?php echo e(url('aboutus')); ?>">About Us</a>
          </li>
          <li class="side-nav-item">
            <a class="side-nav-link nav-link px-2 py-3" aria-current="page" href="<?php echo e(url('contactus')); ?>">Contact Us</a>
          </li>
        </ul>
      ...
      <div class="px-2 py-2 d-lg-none position-absolute bottom-0 w-100">
        <div class="d-flex justify-content-start align-items-center">
          ...
          <div class="d-flex flex-column w-100">
            <a href="<?php echo e(route('profile',Auth::guard('user')->user()->id)); ?>" class="text-decoration-none w-100">
              <div class="rounded px-3 py-3 text-primary w-100 d-flex justify-content-center align-items-center" style="    box-shadow: inset 0px 1px 0px #f5cc7a47;">
                <div class="rounded rounded-circle border border-primary shadow overflow-hidden me-2" style="width:40px;height:40px">
                  <?php if( isset(Auth::guard('user')->user()->profile_img)): ?>
                  <img src="<?php echo e(asset('storage/images/client-profile/'.Auth::guard('user')->user()->profile_img)); ?>" alt="" class="w-100 h-100 user-profile" style="object-fit:cover;" style="object-fit:cover;">
                  <?php else: ?>
                  <img src="<?php echo e(asset('storage/images/client-profile/user.png')); ?>" alt="..." class="w-100 h-100" style="object-fit:cover;" style="object-fit:cover;">
                  <?php endif; ?>
                </div>
                <span class="text-primary usernameSmallDevice usernameToShort"><?php echo e(Auth::guard('user')->user()->name); ?></span>
              </div>
            </a>
    ...
    <nav class="navbar navbar-expand-lg px-2 px-md-0 py-0 fixed-top">
      <div class="container d-flex align-item-center px-0 py-md-1 py-lg-0">
        <a href="<?php echo e(url('/')); ?>" class="logo-div text-decoration-none fs-1 text-gold bg-secondary d-flex justify-content-center align-items-center" style="height: auto;">
          <img src="<?php echo e(asset('image/smtlogo_copy.png')); ?>" alt="" style="width:100%;height:100%">
        </a>
        ...
        <div class="d-none d-lg-inline-flex align-items-center py-1" tabindex="-1" id="offcanvasNavbar">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link pe-0 ps-4 py-3 " aria-current="page" href="<?php echo e(url('/')); ?>">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link pe-0 ps-4 py-3" aria-current="page" href="<?php echo e(url('projectlist')); ?>">Projects</a>
            </li>
            <li class="nav-item">
              <a class="nav-link pe-0 ps-4 py-3" aria-current="page" href="<?php echo e(url('aboutus')); ?>">About Us</a>
            </li>
            <li class="nav-item">
              <a class="nav-link pe-0 ps-4 py-3" aria-current="page" href="<?php echo e(url('contactus')); ?>">Contact Us</a>
            </li>
          </ul>
          ...
          <div class="">
            ...
            <div class="profile-dropdown position-relative">
              ...
              <div class="profile-dropdown position-relative">
                <a href="<?php echo e(route('profile',Auth::guard('user')->user()->id)); ?>" class="text-decoration-none  d-flex justify-content-center align-items-center nav-profile ">
                  <span class="text-primary me-2 usernameLargeDevice usernameToShort"><?php echo e(Auth::guard('user')->user()->name); ?></span>
                  <div class="rounded rounded-circle border border-primary shadow overflow-hidden" style="width:40px;height:40px">
                    <?php if( isset(Auth::guard('user')->user()->profile_img)): ?>
                    <img src="<?php echo e(asset('storage/images/client-profile/'.Auth::guard('user')->user()->profile_img)); ?>" alt="" class="w-100 h-100 user-profile" style="object-fit:cover;">
                    <?php else: ?>
                    <img src="<?php echo e(asset('storage/images/client-profile/user.png')); ?>" alt="..." class="w-100 h-100" style="object-fit:cover;">
                    <?php endif; ?>
                  </div>
                </a>
                ...
                <div class="profile-dropdown-content card bg-secondary bg-opacity-75 border border-1 border-opacity-25 border-primary">
                  <div class="card-body">
                    <div class="d-flex flex-row align-items-center gap-3">
                      ...
                      <div class="">
                        <a href="<?php echo e(route('profile',Auth::guard('user')->user()->id)); ?>" class="text-primary text-decoration-none"><span class="d-block fw-bold usernameLargeDevice usernameToShort text-primary"><?php echo e(Auth::guard('user')->user()->name); ?></span></a>
                        <a href="<?php echo e(route('profile',Auth::guard('user')->user()->id)); ?>" class="text-primary text-decoration-none"><span class="text-primary emailToShort"><?php echo e(Auth::guard('user')->user()->email); ?></span></a>
                      </div>
                    </div>
                    <div class="w-100 bg-primary text-secondary text-center py-2 mt-3">
                      <form method="POST" action="<?php echo e(route('logout')); ?>">
                        ...
                        <!-- <a href="<?php echo e(route('logout')); ?>" class="text-secondary text-decoration-none">LOG OUT</a> -->
                      </form>
                    </div>
                  </div>
                </div>
        ...
        <div class="container-fluid bg-secondary py-3 overflow-hidden">
                            ...
                            <div class=" ms-md-4">
                                <div class="d-flex ">
                                    ...
                                    <div class="ms-md-3">
                                        <ul class="list-group">
                                            <li class="list-group-item bg-transparent border-0 text-gold px-0">
                                                <a href="<?php echo e(url('faq')); ?>" class="text-decoration-none ">
                                                    FAQs
                                                </a>
                                            </li>
                                            <li class="list-group-item bg-transparent border-0 text-gold px-0">
                                                <a href="<?php echo e(url('termcondition')); ?>"
                                                    class="text-decoration-none text-nowrap ">
          ...
          <div class="col-12 text-center bg-white bg-opacity-10 py-3 d-flex justify-content-center align-items-center">
            <div class="pointer mx-2">
              <img src="<?php echo e(asset('image/EnglishFlag.jpg')); ?>" alt="" class="rounded" style="width:40px;height:30px">
              <span class="text-primary d-none d-md-inline">English</span>
            </div>
            <div class="pointer mx-2">
              <img src="<?php echo e(asset('image/BurmaFlag.jpg')); ?>" alt="" class="rounded" style="width:40px;height:30px">
      ...
      <div class="card  border-0 bg-white shadow px-2 py-2 animate__animated animate__fadeIn" style="width:400px;height:fit-content">
        ...
        <div class="card-body">
          ...
          <form enctype="multipart/form-data" class="login-form">
            ...
            <!-- password -->
            <div class="form-floating mb-3">
              <input type="password" name="password" class="form-control form-control-border-bottom <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>" id="floatingInputLoginPassword" placeholder="name@example.com">
    ...
    <div class="register d-flex justify-content-center w-100 bg-secondary bg-opacity-10 py-5 ">
      <div class="card bg-white shadow px-2 py-2 animate__animated animate__fadeIn" style="width:400px;height:fit-content">
        ...
        <div class="card-body">
          ...
          <form action="<?php echo e(route('register')); ?>" method="POST" class="register-form">
            <?php echo csrf_field(); ?>
            <!-- user name -->
            <div class="form-floating mb-3">
    ...
    <div class="forgotPassword d-flex justify-content-center w-100 bg-secondary bg-opacity-10 vh-100 py-5">
      <div class="card  border-0 bg-white shadow px-2 py-2 animate__animated animate__fadeIn" style="width:400px;height:fit-content">
        ...
        <div class="card-body">
          ...
          <form action="<?php echo e(route('forgotPassword')); ?>" id="forgot_password_form" method="POST">
            <?php echo csrf_field(); ?>
            <!-- email -->
            <div class="form-floating mb-5">
              <?php if(auth()->guard('user')->check()): ?>
              <input type="email" name="email" value="<?php echo e(Auth::guard('user')->user()->email); ?>" class="form-control form-control-border-bottom" id="floatingInput" placeholder="name@example.com" />
              <?php else: ?>
  ...
  <script src="<?php echo e(asset('js/counter_up.js')); ?>"></script>
  ...
  <?php echo $__env->yieldPushContent('clientScript'); ?>


</body>
</html>

<?php /**PATH C:\Users\asus\axletech\smt-dyanmic\resources\views/master.blade.php ENDPATH**/ ?>