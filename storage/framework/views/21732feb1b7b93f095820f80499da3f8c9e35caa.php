                ...
                <ul class="side-nav-ul list-group me-auto mb-2 mb-lg-0">
                    <li class="side-nav-item">
                        <a class="side-nav-link nav-link px-2 py-3" aria-current="page"
                            href="<?php echo e(url('/')); ?>"><?php echo e(__('master.home')); ?></a>
                    </li>
                    <li class="side-nav-item">
                        <a class="side-nav-link nav-link px-2 py-3" aria-current="page"
                            href="<?php echo e(url('projectlist')); ?>"><?php echo e(__('master.project')); ?></a>
                    </li>
                    <li class="side-nav-item">
                        <a class="side-nav-link nav-link px-2 py-3" aria-current="page"
                            href="<?php echo e(url('aboutus')); ?>"><?php echo e(__('master.about')); ?></a>
                    </li>
                    <li class="side-nav-item">
                        <a class="side-nav-link nav-link px-2 py-3" aria-current="page"
                            href="<?php echo e(url('contactus')); ?>"><?php echo e(__('master.contact')); ?></a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <select class="form-control changeLang">
                        ...
                        <option value="fr" <?php echo e(session()->get('locale') == 'mm' ? 'selected' : ''); ?>>Myanmar
                        </option>
                        </option>
                    </select>
                </div>
            </div>
            <h1><?php echo e(__('master.home')); ?></h1>
            <!--language-->
